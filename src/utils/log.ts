...
export default class Log {
  ...
  public static async error(msg: string): Promise<void> {
    await this.logger(LogLevel.Error, msg);
  }
  public static async debug(msg: string): Promise<void> {
    await this.logger(LogLevel.Debug, msg);
  }
  public static async trace(msg: string): Promise<void> {
    await this.logger(LogLevel.Trace, msg);
  }
  public static async warn(msg: string): Promise<void> {
    await this.logger(LogLevel.Warn, msg);
  }
