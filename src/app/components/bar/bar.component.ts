...
export class BarComponent extends StylesWatcherComponent implements OnInit, OnDestroy {
    ...
    private async addEventListeners(): Promise<void> {
        this.eventListeners.push(await listen("HideAllWindowsEvent", this.onHideAllWindows));
        this.eventListeners.push(await listen("ShowAllWindowsEvent", this.onShowAllWindows));
        this.eventListeners.push(await listen("FullscreenHideWindow", this.onHideFullscreen));
        this.eventListeners.push(await listen("FullscreenShowWindow", this.onShowFullscreen));
    }
