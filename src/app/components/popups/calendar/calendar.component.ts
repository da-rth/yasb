...
import { MatCalendarView, MatDatepickerModule } from "@angular/material/datepicker";
...
export class CalendarComponent extends StylesWatcherComponent implements OnInit, OnDestroy {
    ...
    public async ngOnInit(): Promise<void> {
        super.ngOnInit();
        this.calendarUnlistenFn = await listen(`${appWindow.label}_show`, async (event: any) => {
